...
@Component({
  ...
  template: `
    <div class="checkout-container">
      <form
        class="checkout-container-item"
        [formGroup]="shippingForm"
        *ngIf="shippingForm"
        (ngSubmit)="formSubmitted($event)"
      >
        <div class="product-container">
          ...
          <mat-radio-group formControlName="mode">
            ...
            <div class="mode-row">
              ...
              <span class="mode-row-detail"
                >( You will pay transportation on your own )</span
              >
            </div>
          </mat-radio-group>
        </div>
        ...
        <div class="product-container">
          ...
          <hr class="line" />
          <p class="mode-detail">
            This information will be used to delivery your goods if you choose
            that mode.
          </p>
          <div class="ship-form">
            <div class="form-field">
              ...
              <mat-hint
                ...
                *ngIf="
                  !(
                    shippingForm.get('mobile').invalid &&
                    shippingForm.get('mobile').touched
                  )
                "
              >
          ...
          <div class="ship-form">
            <div class="form-field">
              ...
              <mat-hint
                ...
                *ngIf="
                  !(
                    shippingForm.get('location').invalid &&
                    shippingForm.get('location').touched
                  )
                "
              >
          ...
          <div class="ship-form">
            <div class="form-field">
              ...
              <mat-hint
                ...
                *ngIf="
                  !(
                    shippingForm.get('notes').invalid &&
                    shippingForm.get('notes').touched
                  )
                "
              >
...
export class CheckoutComponent implements OnInit {
        ...
        .then((user) => {
          this.orderState
            ...
            .then((value) => {
              ...
              this.router
                .navigate([`../orders/${value.id}/payment`], {
  ...
  ngOnInit(): void {
    this.shippingForm = this.formBuilder.group({
      mobile: [
        "",
        [Validators.required, Validators.nullValidator, Validators.minLength(9)]
      ],
      mode: ["pickup"],
      email: [
        "",
